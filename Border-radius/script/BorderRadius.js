...
function updateBorderRadius() {
  ...
  // Atualiza o texto a ser copiado com todos os valores
  document.getElementById(
    "infoText"
  ).textContent = `Border Radius: ${topLeft}px ${topRight}px ${bottomRight}px ${bottomLeft}px`;
}
...
function copyInfoText() {
  const textToCopy = document.getElementById("infoText").innerText;
  navigator.clipboard
...
document.getElementById("copyButton").addEventListener("click", copyInfoText);
